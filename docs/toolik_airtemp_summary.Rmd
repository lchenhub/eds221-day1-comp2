...
```{r}
toolik_weather <- readr::read_csv(here::here("data", "data-raw", "toolik_weather.csv"), na = "#N/A") |> 
  clean_names()
```

```{r}
myAwesomeChart <- ggplot(data = toolik_weather, aes(x = as.factor(month), y = daily_air_temp_mean_c)) +
...
# ggsave(here::here("figs", "myAwesomeChart.jpg"), height = 5, width = 6)
```
